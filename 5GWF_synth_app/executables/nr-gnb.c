...
void init_gNB_Tpool(int inst) {
  ...
  //  - - - - - - - - - - - - - - - - - 
  // ER: Join the TX thread is needed to
  // print X number of frames only
  //threadCreate(&gNB->L1_tx_thread, L1_tx_thread, (void *)gNB, "L1_tx_thread", gNB->L1_tx_thread_core, OAI_PRIORITY_RT_MAX);
  threadCreate_noDetached(&gNB->L1_tx_thread, L1_tx_thread, (void *)gNB, "L1_tx_thread", gNB->L1_tx_thread_core, OAI_PRIORITY_RT_MAX);
